...
function connected(jsn) {
    ...
    $SD.on('de.wolfscoding.placeholders.action.willAppear', (jsonObj) => action.onWillAppear(jsonObj));
    $SD.on('de.wolfscoding.placeholders.action.keyUp', (jsonObj) => action.onKeyUp(jsonObj));
    $SD.on('de.wolfscoding.placeholders.action.sendToPlugin', (jsonObj) => action.onSendToPlugin(jsonObj));
    $SD.on('de.wolfscoding.placeholders.action.didReceiveSettings', (jsonObj) => action.onDidReceiveSettings(jsonObj));
    $SD.on('de.wolfscoding.placeholders.action.propertyInspectorDidAppear', (jsonObj) => {
        console.log('%c%s', 'color: white; background: black; font-size: 13px;', '[app.js]propertyInspectorDidAppear:');
    });
    $SD.on('de.wolfscoding.placeholders.action.propertyInspectorDidDisappear', (jsonObj) => {
